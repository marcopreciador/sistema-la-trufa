            ...
            <div className="p-6 bg-gray-50 border-t border-gray-100 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    ...
                    {committedTotal > 0 && (
                        <button
                            onClick={onVoid}
                            className="col-span-2 py-3 bg-red-50 text-red-600 font-bold rounded-xl hover:bg-red-100 border border-red-200 transition-all flex items-center justify-center space-x-2"
                        >
